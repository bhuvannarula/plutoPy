...
class positionPID:
    def __init__(self) -> None:
        ...
        self.pPOS[Z] = 1.5#2#0.1#2 (1.75, 1, 0.95)
        self.iPOS[Z] = 0.85#3#0.3#.015#.2
        self.dPOS[Z] = 0.95#1.45#1#.1 #(2, 1.6, 1.25) (1.75, 0.95, 1)
    ...
    def output(self, pos_err : list, state : arucoState):
        ...
        result_Z = constrain(self.pPOS[Z] * pos_err[Z], -120, 120)

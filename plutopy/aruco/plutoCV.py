        ...
        if marker_corners:
            ...
            for ids, corners, i in zip(marker_IDs, marker_corners, total_markers):
                ...
                cord_3d = np.float32([
                    ...
                    [bottom_right[0], bottom_left[1], 0],
                    [bottom_left[0], bottom_left[1], 0]
                ])
                #ret, rvec, tvec = cv.solvePnP(cord_3d, corners, self.cam_mat, self.dist_coef)
            ...
            if self.target_id in self.coord_data:
                self.dronePos.update(self.coord_data[self.target_id], self.i_count)
                #print(self.coord_data[self.target_id])
